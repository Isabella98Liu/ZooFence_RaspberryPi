...
#include "../ZooFence_Pi/welcomepage.h"
...
QT_MOC_LITERAL(1, 12, 16), // "switch_index_1_2"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 10) // "textUpdate"

    },
    "welcomePage\0switch_index_1_2\0\0textUpdate"
};
...
void welcomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->switch_index_1_2(); break;
        case 1: _t->textUpdate(); break;
        default: ;
        }
        ...
        {
            typedef void (welcomePage::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&welcomePage::switch_index_1_2)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject welcomePage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_welcomePage.data,
      qt_meta_data_welcomePage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void welcomePage::switch_index_1_2()
{
