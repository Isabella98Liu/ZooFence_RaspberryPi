...
QT_MOC_LITERAL(1, 8, 9), // "showAlert"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 9) // "stopAlert"

    },
    "Thread2\0showAlert\0\0stopAlert"
};
...
void Thread2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showAlert(); break;
        case 1: _t->stopAlert(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread2::showAlert)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Thread2::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread2::stopAlert)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Thread2::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Thread2.data,
      qt_meta_data_Thread2,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void Thread2::showAlert()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void Thread2::stopAlert()
{
