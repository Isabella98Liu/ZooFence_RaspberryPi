...
public:
    ...
    {
        page10->setWindowTitle(QApplication::translate("page10", "Form", Q_NULLPTR));
        pushButton->setText(QApplication::translate("page10", "\346\210\252\345\233\276", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("page10", "\344\277\235\345\255\230", Q_NULLPTR));
