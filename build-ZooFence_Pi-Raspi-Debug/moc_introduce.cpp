...
void introduce::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (introduce::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&introduce::switch_index_2_3)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (introduce::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&introduce::switch_index_2_4)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject introduce::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_introduce.data,
      qt_meta_data_introduce,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *introduce::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_introduce.stringdata0))
        return static_cast<void*>(const_cast< introduce*>(this));
